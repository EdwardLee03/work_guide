...
# 实时查看cache命中率、当前连接数、耗时、set/get数、读/写网络带宽、剔除量等信息
#
# NOTES:
# 参数说明
...
#
# 【示例】
# perl ~/tool/memcached/memcache-top.pl --commands --instances=10.73.14.83:16115
# 
# HISTORY:
#
...
#
# 官方网址：http://memcache-top.googlecode.com/files/memcache-top-v0.6
################################################################################
...
# 字段说明：cache命中率、当前连接数、耗时、set/get数、读/写网络带宽、剔除量
...
# the server name.
	...
	$outstats{cache_hit} = (  $outstats{get_hits} / $outstats{cmd_get} ) * 100;
      }
    }
